...
export const wpOrgSources: WpOrgPluginSource[] = [
  ...
  },
  {
    brand: 'Smash Balloon',
    brandSlug: 'smash-balloon',
    pluginSlug: 'reviews-feed',
    pluginName: 'Reviews Feed',
    trunkReadmeUrl: 'https://plugins.svn.wordpress.org/reviews-feed/trunk/readme.txt',
    accessDefault: 'public',
  },
  {
    brand: 'Smash Balloon',
    brandSlug: 'smash-balloon',
    pluginSlug: 'smashballoon-wpchat-livechat-customer-support',
    pluginName: 'WPChat',
    trunkReadmeUrl: 'https://plugins.svn.wordpress.org/smashballoon-wpchat-livechat-customer-support/trunk/readme.txt',
    accessDefault: 'public',
  },
  {
    brand: 'WP Simple Pay',

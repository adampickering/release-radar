  ...
  return (
    <section className="bg-am-light">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-1 md:gap-0 px-4 md:px-6 pt-5 pb-4">
        ...
        <span className="max-md:hidden text-[12px] text-[#667085]">Scroll for more &rarr;</span>
      </div>
          ...
          return (
            <div
              ...
              className={`min-w-[200px] flex-shrink-0 cursor-pointer rounded-[10px] border bg-white p-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md ${
                hasActiveFilter && activeBrands.includes(brand.slug)
                  ...
                  : hasActiveFilter && !activeBrands.includes(brand.slug)
                    ? 'border-am-border opacity-60 hover:opacity-80'
                    : 'border-am-border'
              }`}
              style={{
            ...
            >
              ...
              <div className="mt-1.5 flex items-center justify-between">
                <span className="text-[10px] text-[#667085]">{brand.pctOfTotal}% of total</span>
